...
const BUTTON_CLASS = 'bg-white rounded px-4 py-2 border border-indigo-600 text-indigo-600 cursor-pointer';

export default function Controller({onClick}: ControllerProps) {
